    ...
    <div class="top">
        ...
        <div class="top_right">
            <div class="top_button">        
                <asp:Button ID="Button15" runat="server" Text="个人中心" OnClick="Button15_Click" />
                <asp:Button ID="Button16" runat="server" Text="退出" OnClick="Button16_Click" />
            </div>
        </div>
    </div>
    <div class="search">
            ...
            <div class="show_content">
                <div class="show_things">
                    ...
                    <div class="buy">
                        ...
                        <div class="btn_buy">
                            <asp:Button CssClass="btn_shopping" ID="Button3" runat="server" Text="购买" OnClick="Button3_Click" />
                ...
                <div class="show_things">
                    ...
                    <div class="buy">
                        ...
                        <div class="btn_buy">
                            <asp:Button CssClass="btn_shopping" ID="Button5" runat="server" Text="购买" OnClick="Button5_Click" />
